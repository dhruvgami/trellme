...
(function() {
  var LocalStrategy, MailService, Tokens, TrelloApi, TrelloOAuth, TrelloView, Trellos, Users, app, authRequired, cluster, config, db_users, dbconnection, express, http, i, notificationLoop, passport, server, _, _i;
