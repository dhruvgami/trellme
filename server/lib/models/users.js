...
(function() {
  var GenPassword, ObjectID, Trellos, Users, dbconnection, mongodb, should, _,
  ...
  module.exports = Users = (function(_super) {
    ...
    Users.prototype.getUserSettings = function(userId, cb) {
      return this.get(userId, function(err, user) {
        if (err) {
          return cb(err, null);
        }
        return new Trellos().getBoards(userId, function(err, boards) {
          var settings;
          if (err) {
            return cb(err, null);
          }
          ...
          settings = _(user.settings).extend({
            boards: boards
          });
    ...
    Users.prototype.saveUserSettings = function(userId, settings, cb) {
      var userSettings;
      ...
      return dbconnection.get_client(function(err, client) {
        return client.collection('users', function(err, collection) {
          ...
          return collection.findAndModify({
            ...
            _(settings.boards).each(function(board) {
              return new Trellos().updateBoard(board._id, {
                enabled: board.enabled
              }, function(err, obj) {
                if (err) {
                  return cb(err, null);
