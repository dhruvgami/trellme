...
(function() {
  var Actions, Boards, Cards, Lists, Members, ObjectID, Trellos, async, dbconnection, mongodb, should, _, _ref,
  ...
  module.exports = Trellos = (function(_super) {
    ...
    function Trellos() {
      _ref = Trellos.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    Trellos.getAllData = function(userId, dateRange, cb) {
      var append, data;
      data = {
        actions: [],
        boards: [],
      ...
      return Boards.findEnabledByUserId(userId, dateRange, function(err, boards) {
        if (err) {
          return cb(err, null);
        }
        if (boards.length === 0) {
