...
(function() {
  var Actions, Boards, Cards, Lists, Members, ObjectID, Trellos, async, dbconnection, mongodb, should, _,
  ...
  module.exports = Trellos = (function(_super) {
    ...
    */
    ...
    Trellos.prototype.getEnabledBoards = function(userId, cb) {
      var _this = this;
      return dbconnection.get_client(function(err, p_client) {
        return p_client.collection('boards', function(err, col) {
          if (err) {
    ...
    Trellos.prototype.getAllLists = function(user_id, fn) {
      var _this = this;
      return dbconnection.get_client(function(err, p_client) {
        return p_client.collection('lists', function(err, col) {
          if (err) {
    ...
    Trellos.getAllData1 = function(userId, cb) {
      ...
      return async.parallel({
        actions: function(callback) {
          return Actions.findByUserId(userId, callback);
        },
        boards: function(callback) {
          return Boards.findEnabledByUserId(userId, callback);
        },
        cards: function(callback) {
          return Cards.findByUserId(userId, callback);
        },
        lists: function(callback) {
          return Lists.findByUserId(userId, callback);
        },
        members: function(callback) {
          return Members.findByUserId(userId, callback);
        }
      ...
      return Boards.findEnabledByUserId(userId, function(err, boards) {
        ...
        if (boards.length === 0) {
          ...
          return _(boards).each(function(board) {
            ...
            return async.parallel({
              actions: function(callback) {
                return Actions.findByBoardId(boardId, callback);
              },
              boards: function(callback) {
                return callback(null, boards);
              },
              cards: function(callback) {
                return Cards.findByBoardId(boardId, callback);
              },
              lists: function(callback) {
                return Lists.findByBoardId(boardId, callback);
              },
              members: function(callback) {
                return Members.findByUserId(userId, callback);
              }
    ...
    Trellos.prototype.get_all_data = function(user_id, fn) {
      ...
      return async.parallel({
        ...
        lists: function(cb) {
          return _this.getAllLists(user_id, function(err, mylists) {
            if (err) {
              return cb(500, 'Couldnt read data');
            } else {
              all.lists = mylists;
